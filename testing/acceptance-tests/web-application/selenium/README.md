...
IDE (Integrated Development Environment) is the tool we use to develop our 
Selenium test cases.
It’s an easy-to-use **Chrome and Firefox extension** and is generally the 
most efficient way to develop test cases. It **records the users’ actions** 
in the browser, using existing Selenium commands, with parameters defined
...
WebDriver uses **browser automation APIs** provided by browser vendors to 
**control browser** and run tests.
